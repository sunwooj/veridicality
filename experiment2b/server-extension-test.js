...
(function() {
  ...
  turk.submit = function(object) {
    ...
    if (submitAddress != 'test' && experimentName != 'test') {
  ...
  // your experiment's JavaScript file should specify BOTH variables, else it won't post
        var uniqueIdentifier = Math.floor((Math.random() * 100000000) + 1);
  ...
  // Else, you're in debug mode - emit the debug output and stop
        ...
        div.innerHTML = "<p><b>Debug mode</b></p>Here is the data that would have been submitted to the Server: <ul>" + htmlify(rawData) + "</ul>"
