...
var experimentName = "test-with-prof-shin3";
var submitAddress = "https://sunwoojeong.com/cgi-bin/process-test-park6.php";
var payment = "test";
...
// var experimentName = "new-server-test200925";
...
function stepExperiment () {
    if (trialnum == 2) { // end the experiment. 
        document.body.scrollTop = document.documentElement.scrollTop = 0;
