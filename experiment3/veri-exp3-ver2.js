...
["door", "유라", ["al", "moreu", "gieok", "ggameok"], ["nv", "mv"], ["ms", "mv"], ["&ldquo;문이 열렸는가?&rdquo;라는 질문에 대한 대답", "&ldquo;문이 열렸구나.&rdquo;라는 생각 혹은 사실"], "문이 열렸다", ["문이 열렸고", "문이 열리지 않았고"], ["문이 열렸다", "문이 열리지 않았다"], "문이 열렸는지", ["안다", "모른다", "기억한다", "까먹었다"]],

["fox", "별이", ["al", "moreu", "gieok", "ggameok"], ["mv", "nv"], ["mv", "eo"], ["&ldquo;여우가 여물을 먹었는가?&rdquo;라는 질문에 대한 대답", "&ldquo;여우가 여물을 먹었구나.&rdquo;라는 생각 혹은 사실"], "여우가 여물을 먹었다", ["여우가 여물을 먹었고", "여우가 여물을 먹지 않았고"], ["여우가 여물을 먹었다", "여우가 여물을 먹지 않았다"], "여우가 여물을 먹었는지", ["안다", "모른다", "기억한다", "까먹었다"]],

["melon", "나영이", ["moreu", "gieok", "ggameok", "al"], ["nv", "mv"], ["es", "mv"], ["&ldquo;메론이 열렸는가?&rdquo;라는 질문에 대한 대답", "&ldquo;메론이 열렸구나.&rdquo;라는 생각 혹은 사실"], "메론이 열렸다", ["메론이 열리지 않았고", "메론이 열렸고"], ["메론이 열리지 않았다", "메론이 열렸다"], "메론이 열렸는지", ["모른다", "기억한다", "까먹었다", "안다"]],

["echo", "유민이", ["moreu", "gieok", "ggameok", "al"], ["mv", "nv"], ["mv", "es"], ["&ldquo;메아리가 울리는가?&rdquo;라는 질문에 대한 대답", "&ldquo;메아리가 울리는구나.&rdquo;라는 생각 혹은 사실"], "메아리가 울린다", ["메아리가 울리지 않고", "메아리가 울리고"], ["메아리가 울리지 않는다", "메아리가 울린다"], "메아리가 울리는지", ["모른다", "기억한다", "까먹었다", "안다"]],

["widow", "윤혜", ["gieok", "ggameok", "al", "moreu"], ["nv", "mv"], ["ev", "mv"], ["&ldquo;의원이 미망인인가?&rdquo;라는 질문에 대한 대답", "&ldquo;의원이 미망인이구나.&rdquo;라는 생각 혹은 사실"], "의원이 미망인이다", ["의원이 미망인이고", "의원이 미망인이 아니고"], ["의원이 미망인이다", "의원이 미망인이 아니다"], "의원이 미망인인지", ["기억한다", "까먹었다", "안다", "모른다"]],

["socks", "민석이", ["gieok", "ggameok", "al", "moreu"], ["mv", "nv"], ["mv", "ev"], ["&ldquo;양말이 어른용인가?&rdquo;라는 질문에 대한 대답", "&ldquo;양말이 어른용이구나.&rdquo;라는 생각 혹은 사실"], "양말이 어른용이다", ["양말이 어른용이 아니고", "양말이 어른용이고"], ["양말이 어른용이 아니다", "양말이 어른용이다"], "양말이 어른용인지", ["기억한다", "까먹었다", "안다", "모른다"]],

["ramen", "종윤이", ["ggameok", "al", "moreu", "gieok"], ["nv", "mv"], ["ed", "mv"], ["&ldquo;메밀을 라면에 넣었는가?&rdquo;라는 질문에 대한 대답", "&ldquo;메밀을 라면에 넣었구나.&rdquo;라는 생각 혹은 사실"], "메밀을 라면에 넣었다", ["메밀을 라면에 넣지 않았고", "메밀을 라면에 넣었고"], ["메밀을 라면에 넣지 않았다", "메밀을 라면에 넣었다"], "메밀을 라면에 넣었는지", ["까먹었다", "안다", "모른다", "기억한다"]],

["year", "윤호", ["ggameok", "al", "moreu", "gieok"], ["mv", "nv"], ["mv", "ed"], ["&ldquo;내란이 을미년에 일어났는가?&rdquo;라는 질문에 대한 대답", "&ldquo;내란이 을미년에 일어났구나.&rdquo;라는 생각 혹은 사실"], "내란이 을미년에 일어났다", ["내란이 을미년에 일어났고", "내란이 을미년에 일어나지 않았고"], ["내란이 을미년에 일어났다", "내란이 을미년에 일어나지 않았다"], "내란이 을미년에 일어났는지", ["까먹었다", "안다", "모른다", "기억한다"]]
