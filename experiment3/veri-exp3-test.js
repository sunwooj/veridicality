...
// var experimentName = "veri-conttext-pilot-crowdworks";
// var submitAddress = "https://sunwoojeong.com/cgi-bin/process-crowdworks.php";
// var payment = "2000won";
...
["socks", "민석이는 양말이 어른용인 줄", "양말이 어른용이다",
    ["mit", "al", "gieok"],
    ["믿어", "알아", "기억해"],
    ["민석이는 양말이 어른용인 줄", "민석이는 양말이 어른용인 줄", "민석이는 양말이 어른용인 줄", "민석이는 양말이 어린이용인 줄"],
    ["verbf", "verbnfs", "verbnfa", "nonverb"],
...
["echo", "유민이는 메아리가 울린 줄", "메아리가 울렸다",
    ["al", "gieok", "mit"],
    ["알아", "기억해", "믿어"],
    ["유민이는 메아리가 울린 줄", "유민이는 메아리가 울린 줄", "유민이는 원래 목소리가 울린 줄", "유민이는 메아리가 울린 줄"],
    ["verbnfs", "verbnfa", "nonverb", "verbf"],
    ["nfgieok", "nfuishim", "ES", "factive"],
    [["기억해", "기억해", "기억해"],
        ["의심해", "의심해", "의심해"],
...
["noodles", "예은이는 잡채에 피망과 버섯을", "예은이는 잡채에 피망을 넣었다",
...
["height", "정우가 남준이보다 나이가", "정우와 남준이는 동갑이다",
    ["filler", "filler", "filler"],
    ["많아", "많아", "많아"],
...
function stepExperiment () {
    if (trialnum == 16) { // end the experiment. 
        document.body.scrollTop = document.documentElement.scrollTop = 0;
        showSlide("language");
