...
["fox", "별이", 
    ["al", "moreu", "gieok", "ggameok"], 
    ["mv", "nv"], ["mv", "eo"], 
    ["&ldquo;여우가 여물을 먹었는가?&rdquo;라는 질문에 대한 대답", "&ldquo;여우가 여물을 먹었다.&rdquo;"], 
    "여우가 여물을 먹었다", 
...
["melon", "나영이", 
    ...
    ["nv", "mv"], ["es", "mv"], 
    ["&ldquo;메론이 열렸는가?&rdquo;라는 질문에 대한 대답", "&ldquo;메론이 열렸다.&rdquo;"], 
    "메론이 열렸다", 
    ["메론이 열리지 않았고", "메론이 열렸고"], ["메론이 열리지 않았다", "메론이 열렸다"], ["neg", "pos"], 
    ["모른다", "기억한다", "까먹었다", "안다"], 
    ["알지 못한다", "기억한다(생각한다)", "기억하지 못한다", "안다(생각한다)"],
    // ["알지 못한다 (혹은 생각하지 않는다)", "기억한다 (혹은 생각한다)", "기억하지 못한다 (혹은 생각하지 않는다)", "안다 (혹은 생각한다)"], 
    ["모른다", "기억한다(고 생각한다)", "까먹었다", "안다(고 생각한다)"]
...
["echo", "유민이", 
    ["moreu", "gieok", "ggameok", "al"], 
    ["mv", "nv"], ["mv", "es"], 
    ["&ldquo;메아리가 울리는가?&rdquo;라는 질문에 대한 대답", "&ldquo;메아리가 울린다.&rdquo;"], 
    "메아리가 울린다", 
...
["widow", "윤혜", 
    ...
    ["nv", "mv"], ["ev", "mv"], 
    ["&ldquo;의원이 미망인인가?&rdquo;라는 질문에 대한 대답", "&ldquo;의원이 미망인이다.&rdquo;"], 
    "의원이 미망인이다", 
    ["의원이 미망인이고", "의원이 미망인이 아니고"], ["의원이 미망인이다", "의원이 미망인이 아니다"], ["pos", "neg"], 
    ["기억한다", "까먹었다", "안다", "모른다"], 
    ["기억한다(생각한다)", "기억하지 못한다", "안다(생각한다)", "알지 못한다"],
    // ["기억한다 (혹은 생각한다)", "기억하지 못한다 (혹은 생각하지 않는다)", "안다 (혹은 생각한다)", "알지 못한다 (혹은 생각하지 않는다)"], 
    ["기억한다(고 생각한다)", "까먹었다", "안다(고 생각한다)", "모른다"]
...
["socks", "민석이", 
    ["gieok", "ggameok", "al", "moreu"], 
    ["mv", "nv"], ["mv", "ev"], 
    ["&ldquo;양말이 어른용인가?&rdquo;라는 질문에 대한 대답", "&ldquo;양말이 어른용이다.&rdquo;"], 
    "양말이 어른용이다", 
...
["ramen", "종윤이", 
    ...
    ["nv", "mv"], ["ed", "mv"], 
    ["&ldquo;메밀을 라면에 넣었는가?&rdquo;라는 질문에 대한 대답", "&ldquo;메밀을 라면에 넣었다.&rdquo;"], 
    "메밀을 라면에 넣었다", 
    ["메밀을 라면에 넣지 않았고", "메밀을 라면에 넣었고"], ["메밀을 라면에 넣지 않았다", "메밀을 라면에 넣었다"], ["neg", "pos"], 
    ["까먹었다", "안다", "모른다", "기억한다"], 
    ["기억하지 못한다", "안다(생각한다)", "알지 못한다", "기억한다(생각한다)"],
    // ["기억하지 못한다 (혹은 생각하지 않는다)", "안다 (혹은 생각한다)", "알지 못한다 (혹은 생각하지 않는다)", "기억한다 (혹은 생각한다)"], 
    ["까먹었다", "안다(고 생각한다)", "모른다", "기억한다(고 생각한다)"]
...
["year", "윤호", 
    ["ggameok", "al", "moreu", "gieok"], 
    ["mv", "nv"], ["mv", "ed"], 
    ["&ldquo;내란이 을미년에 일어났는가?&rdquo;라는 질문에 대한 대답", "&ldquo;내란이 을미년에 일어났다.&rdquo;"], 
    "내란이 을미년에 일어났다", 
...
["age", "나", 
    ...
    ["dec", "dec"], ["dec", "dec"],
    ["&ldquo;수영이는 서현이보다 나이가 많은가?&rdquo;라는 질문에 대한 대답", "&ldquo;수영이는 서현이보다 나이가 많다.&rdquo;"], "서현이는 수영이보다 나이가 적다",
...
["conch", "나",
    ["filler", "filler", "filler", "filler"],
    ["pq", "pq"], ["pq", "pq"],
    ["&ldquo;진희는 어항에 소라게를 키우고 있는가?&rdquo;라는 질문에 대한 대답", "&ldquo;진희는 어항에 소라게를 키우고 있다.&rdquo;"], "진희는 어항에 소라게를 키우고 있다",
...
["height", "나",
    ["filler", "filler", "filler", "filler"],
    ["dec", "dec"], ["dec", "dec"],
    ["&ldquo;준홍이는 홍석이보다 키가 큰가?&rdquo;라는 질문에 대한 대답", "&ldquo;준홍이는 홍석이보다 키가 크다.&rdquo;"], 
    "홍석이는 준홍이보다 키가 작다",
...
["exam", "나",
    ["filler", "filler", "filler", "filler"],
    ["pq", "pq"], ["pq", "pq"],
    ["&ldquo;슬기는 시험에서 90점 이상의 점수를 받았는가?&rdquo;라는 질문에 대한 대답", "&ldquo;슬기는 시험에서 90점 이상의 점수를 받았다.&rdquo;"], 
